          ...
          <SheetHeader className='p-4'>
            ...
            <div className="flex items-center gap-4 rounded-xl bg-gradient-to-br from-blue-100 to-indigo-200 p-4 shadow-md">
                ...
                <div className="flex flex-col">
                  <h1 className="text-xl font-bold text-gray-800 text-shadow-md leading-tight">
                    Gajanan Enterprises
                  </h1>
                  {role === 'shop' && (
                    <span className="text-xl font-bold text-gray-800 text-shadow-md leading-tight mt-0.5">
                      Ghataprabha
                    </span>
                  )}
                </div>
